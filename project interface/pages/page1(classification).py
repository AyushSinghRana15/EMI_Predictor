...
model=joblib.load("emi_classification.joblib")
...
marital_status = st.selectbox("Marital Status ", [0,1], index=1)
education = st.number_input("Education (Professional=0,Graduate=1,HighSchool=2)", 0, 10, 0)
...
if st.button("Predict Eligibility"):
    ...
    st.success(f"Predicted EMI Eligibility Class: {prediction}")
